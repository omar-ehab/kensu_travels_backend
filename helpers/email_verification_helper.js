...
const textMail = (first_name, token) => {
    return `
        Hello ${first_name}
        please verify your account by coping the link below and past it in your browser\n
        http://localhost:3000/verify/${token}
    `;
}


const htmlMail = (first_name, token) => {
    return `
                                                    ...
                                                    <tr>
                                                      <td style="padding:0px;margin:0px;border-spacing:0;">
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                                                                <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="600" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://localhost:3000/meteora.png" height="200">
                                                              </td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
                                                        <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="948e3f3f-5214-4721-a90e-625a47b1c957" data-mc-module-version="2019-10-22">
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Thanks for signing up, ${first_name}&nbsp;</span></div><div></div></div></td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
                                                              ...
                                                              <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="font-size: 18px">Please verify your email address and</span>
                                                                    <span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> you will get access to over 40 million of facebook account data</span> 
                                                                    <span style="font-size: 18px">.</span>
                                                                  </div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="color: #F8BC59; font-size: 18px"><strong>Thank you!&nbsp;</strong></span>
                                                                  </div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                              ...
                                                              <tr>
                                                                <td align="center" bgcolor="#ffffff" class="outer-td" style="padding:0px 0px 0px 0px;">
                                                                  <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                                                                    <tbody>
                                                                      <tr>
                                                                      <td align="center" bgcolor="#F8BC59" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                        <a href="http://localhost:3000/verify/${token}" style="background-color:#F8BC59; border:1px solid #F8BC59; border-color:#F8BC59; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Verify Email Now</a>
...
const send_verifiecation_mail = (name, to, token) => {
  const message = {
      to,
      from: "topdollar57@gmail.com",
      subject : "Kensu Traveles Email Verification",
      text: textMail(name, token),
      html: htmlMail(name, token),
  }
  try{
    sgMail.send(message)
  } catch(error) {
...
module.exports = send_verifiecation_mail;
